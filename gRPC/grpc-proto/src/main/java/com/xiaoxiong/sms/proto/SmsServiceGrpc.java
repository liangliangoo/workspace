...
public final class SmsServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.xiaoxiong.sms.proto.SmsProto.SmsRequest,
      com.xiaoxiong.sms.proto.SmsProto.SmsResponse> getSendSmsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "sendSms",
      requestType = com.xiaoxiong.sms.proto.SmsProto.SmsRequest.class,
      responseType = com.xiaoxiong.sms.proto.SmsProto.SmsResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
  public static io.grpc.MethodDescriptor<com.xiaoxiong.sms.proto.SmsProto.SmsRequest,
      com.xiaoxiong.sms.proto.SmsProto.SmsResponse> getSendSmsMethod() {
    io.grpc.MethodDescriptor<com.xiaoxiong.sms.proto.SmsProto.SmsRequest, com.xiaoxiong.sms.proto.SmsProto.SmsResponse> getSendSmsMethod;
      ...
      synchronized (SmsServiceGrpc.class) {
        if ((getSendSmsMethod = SmsServiceGrpc.getSendSmsMethod) == null) {
          SmsServiceGrpc.getSendSmsMethod = getSendSmsMethod =
              io.grpc.MethodDescriptor.<com.xiaoxiong.sms.proto.SmsProto.SmsRequest, com.xiaoxiong.sms.proto.SmsProto.SmsResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "sendSms"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.xiaoxiong.sms.proto.SmsProto.SmsRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.xiaoxiong.sms.proto.SmsProto.SmsResponse.getDefaultInstance()))
  ...
  public static abstract class SmsServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void sendSms(com.xiaoxiong.sms.proto.SmsProto.SmsRequest request,
        io.grpc.stub.StreamObserver<com.xiaoxiong.sms.proto.SmsProto.SmsResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncServerStreamingCall(
              new MethodHandlers<
                com.xiaoxiong.sms.proto.SmsProto.SmsRequest,
                com.xiaoxiong.sms.proto.SmsProto.SmsResponse>(
  ...
  public static final class SmsServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<SmsServiceBlockingStub> {
    ...
    /**
     */
    public java.util.Iterator<com.xiaoxiong.sms.proto.SmsProto.SmsResponse> sendSms(
        com.xiaoxiong.sms.proto.SmsProto.SmsRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SEND_SMS:
          serviceImpl.sendSms((com.xiaoxiong.sms.proto.SmsProto.SmsRequest) request,
              (io.grpc.stub.StreamObserver<com.xiaoxiong.sms.proto.SmsProto.SmsResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class SmsServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.xiaoxiong.sms.proto.SmsProto.getDescriptor();
    }
