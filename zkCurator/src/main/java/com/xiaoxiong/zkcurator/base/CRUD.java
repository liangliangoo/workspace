...
public class CRUD {
    //本机
   private static final String ZK_ADDRESS = "192.168.44.128:2181";

    //虚拟机
    // private static final String ZK_ADDRESS = "cdh1:2181";

    private CuratorFramework getInstance() {
        CuratorFramework client = CuratorFrameworkFactory.newClient(ZK_ADDRESS, new ExponentialBackoffRetry(1000, 10));
        return client;
    }
    /**
     * 检查节点
    ...
    public void createNode() {
        ...
        try {
            ...
            log.info("forPath耗费时间ms："+ (System.currentTimeMillis()-stime));
